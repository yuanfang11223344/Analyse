# Design Compiler Training Fudan - 总结（逐页深读笔记版）

## 本次重构说明

上一版按 20 页分块并使用 contact sheet，适合快速概览，但不适合逐页学习。这一版改为 112 个单页读书笔记：每页都保留原始截图，并按“页面定位、原文摘录、页面结构与图示分析、原文逐项解读、关键概念拆解、我的理解、对我们的启示、本页小结”组织。
...
- [逐页索引](INDEX.md)
- [合并版逐页深读笔记](page-by-page-notes.md)
- [单页笔记目录](pages/)
- [单页截图目录](assets/pages/)
- [原文抽取证据目录](sources/)
