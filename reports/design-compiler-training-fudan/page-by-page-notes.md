...
- 上一页：[Page 009](page-009.md)
- 下一页：[Page 011](page-011.md)
...
- 上一页：[Page 017](page-017.md)
- 下一页：[Page 019](page-019.md)
...
- 上一页：[Page 018](page-018.md)
- 下一页：[Page 020](page-020.md)
...
- 上一页：[Page 022](page-022.md)
- 下一页：[Page 024](page-024.md)
...
本页的核心收获：Set Input Pulling Resistance (khoms) 这一页应被理解为“配置综合库”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
本页的核心收获：Setting Output Loading Capacitance (pF) 这一页应被理解为“配置综合库”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
本页的核心收获：set_fanout_load V.S. set_max_fanout 这一页应被理解为“配置综合库”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
本页的核心收获：Case Study 这一页应被理解为“配置综合库”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
本页的核心收获：Wire Load Model 这一页应被理解为“区分扇出环境和扇出规则”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
- 上一页：[Page 037](page-037.md)
- 下一页：[Page 039](page-039.md)
...
本页的核心收获：- set _wire_load_model -name “10*10” -library my_lib.db 这一页应被理解为“配置综合库”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
- 上一页：[Page 042](page-042.md)
- 下一页：[Page 044](page-044.md)
...
- 上一页：[Page 046](page-046.md)
- 下一页：[Page 048](page-048.md)
...
- 上一页：[Page 052](page-052.md)
- 下一页：[Page 054](page-054.md)
...
- 上一页：[Page 053](page-053.md)
- 下一页：[Page 055](page-055.md)
...
- 上一页：[Page 060](page-060.md)
- 下一页：[Page 062](page-062.md)
...
- 上一页：[Page 063](page-063.md)
- 下一页：[Page 065](page-065.md)
...
- 上一页：[Page 065](page-065.md)
- 下一页：[Page 067](page-067.md)
...
- 上一页：[Page 068](page-068.md)
- 下一页：[Page 070](page-070.md)
...
本页的核心收获：Sequential Mapping 这一页应被理解为“配置综合库”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
- 上一页：[Page 076](page-076.md)
- 下一页：[Page 078](page-078.md)
...
- 上一页：[Page 077](page-077.md)
- 下一页：[Page 079](page-079.md)
...
本页的核心收获：Clock Tree Modeling Example 这一页应被理解为“设置时序预算”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
本页的核心收获：Effect of Clock Tree Modeling on Setup 这一页应被理解为“配置综合库”的读书笔记节点；掌握它的标准不是背下标题，而是能说明它如何影响后续约束、优化或 timing 报告。
...
- 上一页：[Page 087](page-087.md)
- 下一页：[Page 089](page-089.md)
...
- 上一页：[Page 090](page-090.md)
- 下一页：[Page 092](page-092.md)
...
- 上一页：[Page 093](page-093.md)
- 下一页：[Page 095](page-095.md)
...
- 上一页：[Page 094](page-094.md)
- 下一页：[Page 096](page-096.md)
...
- 上一页：[Page 097](page-097.md)
- 下一页：[Page 099](page-099.md)
...
- 上一页：[Page 101](page-101.md)
- 下一页：[Page 103](page-103.md)
...
- 上一页：[Page 102](page-102.md)
- 下一页：[Page 104](page-104.md)
...
- 上一页：[Page 103](page-103.md)
- 下一页：[Page 105](page-105.md)
...
- 上一页：[Page 108](page-108.md)
- 下一页：[Page 110](page-110.md)
