...
# 增加一个新的远程仓库，并命名,shortname：主机别名，一般默认为 origin
...
- [《git cherry-pick 教程》](http://www.ruanyifeng.com/blog/2020/04/git-cherry-pick.html) 复制某分支上的部分提交到另一个分支上
